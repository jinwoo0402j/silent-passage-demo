...
export function createRunState(data, meta) {
  ...
  const player = {
    ...
    sprintDirection: 0,
    sprintPrimed: false,
    capsDashLastTapDirection: 0,
    capsDashTapTimer: 0,
    capsDashHoldDirection: 0,
    noMoveInputTimer: 0,
    horizontalDecelTimer: 0,
    horizontalDecelDuration: 0,
    horizontalDecelStartSpeed: 0,
    horizontalDecelDirection: 0,
    horizontalTurnTimer: 0,
    horizontalTurnDuration: 0,
    horizontalTurnStartVx: 0,
    horizontalTurnTargetVx: 0,
    horizontalTurnDirection: 0,
    ...
    wallRunClimbLimit: 0,
    wallRunWallId: null,
    wallRunTimedOutDirection: 0,
    wallRunTimedOutWallId: null,
    wallRunLockedTargets: [],
    ...
    recoilDirY: -1,
    recoilCameraTimer: 0,
    recoilCameraHoldUntilLanding: false,
  ...
  return {
    ...
    cameraLookAhead: 0,
    cameraDownLookAhead: 0,
    cameraSpeedRatio: 0,
    cameraSpeedRawRatio: 0,
    cameraSpeedHoldRatio: 0,
    cameraSpeedHoldReturning: false,
