...
const CAMERA_NUMBER_FIELDS = [
  ...
  ["lookAheadMinFocusX", 0.24, 0.08, 0.5],
  ["lookAheadMaxFocusX", 0.76, 0.5, 0.92],
  ...
  ["inputLookAheadBoost", 0, 0, 0.25],
  ["inputDirectionLerp", 8, 0, 40],
  ["fallDownSpeedStart", 240, 0, 2400],
  ["fallDownSpeedFull", 1120, 1, 3600],
  ["fallDownFocusStartY", 0.46, 0.06, 0.72],
  ["fallDownFocusFullY", 0.38, 0.06, 0.72],
  ["fallMinFocusY", 0.18, 0.04, 0.28],
  ["fallZoom", 0.94, 0.1, 1],
  ["fallSpeedZoomMultiplier", 0.55, 0, 2],
  ["fallCameraCenterOffset", 0, 0, 1200],
  ["keepPlayerVisibleMarginY", 0, 0, 600],
  ["fallReturnHoldMs", 240, 0, 2000],
  ["fallFocusLerp", 8.5, 0, 40],
  ["fallCatchUpLerp", 12, 0, 60],
  ["fallReturnLerp", 3.6, 0, 40],
  ["fallLandingProbeDistance", 620, 0, 3000],
  ["fallLandingProbeMaxTime", 0.72, 0, 3],
  ["fallLandingCameraPull", 0.22, 0, 1],
  ["fallLandingCameraMaxOffset", 150, 0, 800],
  ["directionSpeedThreshold", 70, 0, 300],
  ["sprintCameraMinSpeed", 260, 0, 1200],
  ["speedDownLookAhead", 0, 0, 0.35],
  ["speedDownLookAheadStart", 360, 0, 1600],
  ["speedDownLookAheadFull", 620, 1, 2400],
  ["speedDownGroundMultiplier", 0.18, 0, 2],
  ["speedDownAirMultiplier", 1.15, 0, 2],
  ["speedDownFallMultiplier", 1.25, 0, 2],
  ["speedDownFocusLerp", 5.5, 0, 40],
  ["speedZoomStart", 260, 0, 1600],
  ["speedZoomFull", 980, 1, 2400],
  ["speedZoomMin", 0.88, 0.1, 1],
  ["speedCameraHoldMinRatio", 0.12, 0, 1],
  ["speedCameraReleaseSpeed", 48, 0, 320],
  ["speedCameraReturnLerp", 2.2, 0, 20],
